...
ROUTES = [
    ...
    "POST /api/artel/prestige _api_artel_prestige",
    "GET /app _spa",
    "GET /app/{tail} _spa",
    ...
    "GET /world/raid.json _world_raid",
    ...
    "POST /api/invasion/prepare _api_invasion_prepare",
    ...
    "POST /api/gear/equip _api_gear_equip",
    "POST /api/gear/unequip _api_gear_unequip",
