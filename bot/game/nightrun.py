...
MEET_ENCOUNTERS = {
    "smuggler": {
        ...
        "options": [
            ("buy",  "🤝 Взять товар", 1.6, [("thieves", +1), ("watch", -1)]),
            ("turn", "🛡 Сдать страже", 1.1, [("watch", +1), ("thieves", -1)]),
        ],
    },
    "taxman": {
        "npc": "👑 Сборщик податей",
        ...
        "options": [
            ("pay",  "💰 Заплатить пошлину", 0.8, [("crown", +1)]),
    ...
    "monk": {
        ...
        "options": [
            ("alms",   "🙏 Подать на храм", 0.8, [("church", +1)]),
            ("ignore", "🍺 Отмахнуться", 1.1, [("church", -1)]),
        ],
    },
    "caravan": {
        "npc": "💰 Обоз Купеческой лиги",
        "scene": "тяжёлый обоз лиги ползёт через заставу — возчики зыркают, охрана клюёт носом.",
        "options": [
            ("escort", "🤝 Подсобить, проводить", 0.9, [("merchants", +1)]),
            ("waylay", "🗡 Обчистить обоз", 1.7, [("merchants", -1), ("thieves", +1)]),
        ],
    },
}
