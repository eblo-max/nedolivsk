...
SEASONS: list[Season] = [
    Season("spring", "Весна", "🌸", 1.0, 1.0,
           ...
           "природа оживает — травы, вода и дичь в достатке"),
    Season("summer", "Лето", "☀️", 1.08, 1.0,
           {"berries": 1.2, "honey": 1.2, "water": 1.15},
           "жара гонит народ в кабаки — спрос выше, ягоды да мёд в цвету"),
    Season("autumn", "Осень", "🍂", 1.0, 1.0,
           {"grain": 1.25, "hops": 1.25, "berries": 1.25, "herbs": 1.25,
            "honey": 1.2},
           "урожай — закрома ломятся от добра"),
    Season("winter", "Зима", "❄️", 0.92, 0.85, {},
           "стужа — добывать тяжко, да и народ сидит по домам"),
]
