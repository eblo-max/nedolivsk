...
# Сбыт эля (Ярус 2 → доход): гости раскупают погреб
DEMAND_PER_CAPACITY = 0.5   # кружек/час спроса на единицу вместимости
ALE_REP_GATE = {1: 0, 2: 40, 3: 120}  # репутация, чтобы ярус вообще раскупали
REP_PER_ALE_SOLD = 25       # +1 репутации за столько проданных кружек
