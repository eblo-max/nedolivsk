...
BOURSE_OPEN = False             # блок «Биржа» в Торге: False → только админ (обкатка); True → всем
...
HEAL_VALUES = {
    # еда — сытно лечит
    "pie": 13, "roast": 12, "cured": 9, "smoked_fish": 9, "cheese": 8, "bread": 6, "butter": 5,
    # питьё — глушит боль / согревает
    "sbiten": 11, "mead": 9, "wine": 8, "ale3": 8, "ale2": 6, "ale1": 4,
}
