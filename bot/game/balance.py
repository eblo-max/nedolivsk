...
# в погребе — уходят недовольными (минус репутация). Стимул докупать премиум-товар.
PREMIUM_MIN_PRICE = 10      # дешевле — «простое пойло», богачи не берут
PREMIUM_LEAVE_DIV = 6       # столько ушедших богачей = −1 репутации
PREMIUM_LEAVE_MAX_LOSS = 3  # не больше −3 реп за один сбор (мягко, без обвала)
