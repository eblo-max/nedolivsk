...
class Boss:
    ...
    sprite: str = ""        # имя спрайт-листа в мини-аппе (public/boss/<sprite>.png);
                            # "" = фолбэк на крупный эмодзи. Лист: 22×5, кадр 288×160,
                            # строки idle/walk/cleave/take_hit/death (см. RaidSheet).
