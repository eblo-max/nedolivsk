...
class WorldState(Base):
    ...
    # Живой мир: NPC-трейдеры/посты/цель недели — ОТДЕЛЬНО от market (рынок
    # ждёт в market только числа-перекосы; словари здесь роняли decay 02.07).
    live: Mapped[dict] = mapped_column(_JDICT, default=dict)
