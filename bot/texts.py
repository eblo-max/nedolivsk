...
RULES = (
    ...
    "Кнопка «Собрать доход»: <u>пассив</u> (таверна капает сама) падает сразу, "
    "а по <u>сбыту</u> гости говорят, сколько хотят выкупить — и ты сам решаешь: "
    "<u>налить</u> или <u>придержать</u> товар (вдруг продашь дороже купцу или с "
    "молотка). Гости разные: <u>состоятельные</u> берут дорогое, <u>пьянь</u> — "
    "дешёвое, <u>голод</u> разбирает еду. Больше вместимость и репутация — больше "
    "гостей и богатеев, выше выручка.\n\n"
    ...
    "<b>🤝 8. Торг с купцом</b>\n"
    "На сбор дохода иногда заглядывает заезжий купец и хочет купить партию из "
    "погреба. Ты ставишь цену — он соглашается, торгуется или уходит, смотря по "
    "нраву (жмот, ценитель, гуляка…). Дороже розницы, но цену надо угадать.\n\n"

    "<b>🔨 9. Аукцион</b>\n"
    "Раздел «Аукцион»: выставляешь лот (товар + стартовая цена) и ждёшь — "
    "горожане сами перебивают ставки по таймеру. Хорошее настроение города и "
    "дефицит товара гонят ставки вверх. Товар на торгах заморожен.\n\n"

    "<b>🏪 10. Базар — живые цены</b>\n"
    "Раздел «Рынок»: оптовые цены чата дышат сами. Завалишь рынок продажами — "
    "цена просядет; дефицит и купеческий бум — взлетит. Купец и аукцион считают "
    "цену по базару, так что подгадывай момент.\n\n"

    "<b>🏹 11. Охота</b>\n"
    "С экрана «Персонаж → Охота» бьёшь зверьё своей снарягой (урон/крит/броня). "
    "Выбираешь добычу по силе — видишь свой шанс и таблицу добычи заранее. "
    "Победа — мясо, шкуры, золото, редкие трофеи; поражение — раны. Здоровье "
    "тратится в бою и восстанавливается со временем; ранен — отлёживайся.\n\n"

    "<b>🎁 12. Подкидыш в чате</b>\n"
    "Иногда в общий чат падает «что-то потерялось» с кнопкой «Поднять». Кто "
    "первый нажал — забрал: то ресурсы, то пусто, то всякая дрянь. Не зевай.\n\n"
