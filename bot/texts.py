...
RULES = (
    ...
    "<i>Из вонючей наливайки — в богатейший двор округи. Меряемся по "
    "ВВП (рейтинг «гг топ»).</i>\n\n"

    "<b>⛏ 1. Бригады за сырьём.</b>\n"
    "Гонишь работяг на вылазки — за деревом, зерном, хмелем, мёдом, ягодой и "
    "прочим добром. Платишь золотом, через время возвращаются с грузом. Чем "
    "выше уровень таверны — тем больше бригад уходит разом.\n\n"

    "<b>🏗 2. Пристройки = производство.</b>\n"
    "• <b>Мельница</b>: зерно → солод\n"
    "• <b>Пивоварня</b>: солод + хмель → эль\n"
    "• <b>Медоварня</b>: мёд → медовуха и сбитень\n"
    "• <b>Кухня</b>: припасы → жаркое\n"
    "• <b>Винодельня</b>: ягоды → вино\n"
    "Часть открывается по репутации.\n\n"

    "<b>🍺 3. Партии и погреб.</b>\n"
    "Запускаешь варку/готовку, ждёшь, разливаешь в погреб. Эль можно поставить "
    "на <b>выдержку</b> и рискнуть поднять ярус (★ → ★★★) — но партия может и "
    "скиснуть. Богатый товар дороже, но и спрос на него уже.\n\n"

    "<b>💰 4. Доход.</b>\n"
    "Кнопка «Собрать доход» = пассив таверны + сбыт из погреба. Гости разные: "
    "<b>состоятельные</b> берут дорогое, <b>пьянь</b> — что подешевле; "
    "отдельно идёт <b>голод</b> на еду. Больше вместимость и репутация — больше "
    "спрос и выше доля богатеев.\n\n"

    "<b>⭐ 5. Репутация и улучшение.</b>\n"
    "Репутация растёт со сбыта: открывает пристройки и приводит богатую публику. "
    "Улучшение таверны жрёт сырьё, но поднимает вместимость, комфорт, пассив и "
    "число бригад.\n\n"

    "<b>⚒ 6. Кузница и снаряга.</b>\n"
    "Заказываешь у мастера шапку, броню, сапоги, пояс, суму, оружие, амулет. "
    "Надетое ускоряет вылазки, повышает добычу, доход и удачу. Перековка — "
    "выше ярус. Бывают <b>счастливые вылазки</b>: добыча кратно жирнее.\n\n"

    "<b>🎪 7. Ярмарка.</b>\n"
    "Раз в день съезжаются купцы — спрос <b>×2</b> на пару часов. В чат заранее "
    "падает анонс: копи бочки и куй железо, пока горячо.\n\n"

    "<b>🗺 Где играть.</b>\n"
    "В личке — кнопками. В общем чате — словом «гг» (см. «гг помощь»). "
    "Уведомления о готовности падают прямо в чат с кнопкой «Забрать»."
)
