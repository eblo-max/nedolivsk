...
.tav-pop .atitle.st-silver{background:linear-gradient(180deg,#eef3fa,#a7b4c6);border-color:#7d8ba0;color:#20293a}
.tav-pop .atitle.st-gold{background:linear-gradient(180deg,#f8e08c,#d29c3d);border-color:#b58a2c}
.tav-pop .atitle.st-neon{background:#08131a;border-color:#22e0ff;color:#8dfcff;text-shadow:0 0 5px #22e0ff;box-shadow:0 0 8px #22e0ff88}
.tav-pop .atitle.st-plasma{background:#160a18;border-color:#ff33d6;color:#ffa6f0;text-shadow:0 0 5px #ff33d6;box-shadow:0 0 8px #ff33d688}
.tav-pop .atitle.st-frost{background:linear-gradient(180deg,#1c3d4e,#0c2230);border-color:#a6ecff;color:#eafaff;text-shadow:0 0 5px #7fd8ff}
.tav-pop .atitle.st-ember{background:linear-gradient(180deg,#3a1400,#170700);border-color:#ff6a1a;color:#ffe1b3;text-shadow:0 0 6px #ff5a1a;box-shadow:0 0 9px #ff5a1a88}
.tav-pop .atitle.st-void{background:radial-gradient(circle,#2c1246,#0b0512);border-color:#7e3aff;color:#dcb8ff;text-shadow:0 0 6px #9a4aff;box-shadow:0 0 9px #7e3aff88}
.tav-pop .atitle.st-holo{border-color:#fff;color:#fff;text-shadow:0 1px 2px #0009;
  background:linear-gradient(100deg,#ff6b8b,#ffd36b,#8bffb0,#6bb8ff,#c46bff,#ff6b8b);background-size:320% 100%;
  animation:rarsh 4.2s linear infinite;box-shadow:0 0 12px #ffffff66}
@keyframes rarsh{0%{background-position:0%}100%{background-position:320%}}
...
fetch('/world/taverns.json?uid='+uid).then(function(r){return r.json();}).then(function(d){
  ...
  tv.forEach(function(t){
    ...
    m.bindTooltip((t.facade?t.facade.emoji+' ':'')+esc(t.name),{permanent:true,direction:'top',className:'tav-label'+(t.mine?' tl-mine':'')+(crowned?' tl-crown':''),offset:[0,-sz*0.78]});
